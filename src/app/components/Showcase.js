            ...
            <div className='wrapper'>
                <div className='lg:max-w-md'>
                    ...
                    <div className='space-y-5 mt-7 pe-10'>
                        ...
                        <p>
                            It drives Apple intelligence on ipad Pro, so you can write, create, and accomplish more with ease. All in a design that's inbelievable thin, light and powerful.
                        </p>
                ...
                <div className='max-w-3xs space-y-14'>
                    <div className='space-y-2'>
                        <p>Up to</p>
                        <h3>4x faster</h3>
                        <p>pro render performance than M2</p>
                    </div>
